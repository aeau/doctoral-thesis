...
\newcommand{\printISBN}{978-91-7877-307-7}
\newcommand{\pdfISBN}{978-91-7877-308-4}
\newcommand{\doi}{10.24834/isbn.9789178773084}
\newcommand{\printCompany}{Media-Tryck, Lund}

%ISBN 978-91-7877-307-7 (print)
%ISBN 978-91-7877-308-4 (pdf)
%On the first row below the ISBN and ISSN you should put the DOI: 
...
For all publications above except for [1], [2], and [7], the first author was the main contributor with regards to inception, planning, execution and writing of the research. %For [4], both authors contributed equally.
